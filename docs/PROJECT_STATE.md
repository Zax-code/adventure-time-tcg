...
Verified baseline commit: `4f8946b5481d6fadb2212df7bb2de41960ec7de2`
...
- **2026-08-25 — Speed Calculus result sharing and Expo patch alignment:** mobile can share one, two, or all three recorded Speed Calculus runs from the quest screen or the daily recap; every run shows errors/correct answers, accuracy percentage, and absolute score. The workspace and iOS Pod lock are aligned with Expo/Expo Router 57.0.16 and the current SDK 57 patch matrix; Expo Doctor passes all 20 checks.
