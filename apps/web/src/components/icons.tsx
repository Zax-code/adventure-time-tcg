...
export function PackIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
...
export function QuestIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path
...
export function TrophyIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M6 5H4C3.45 5 3 5.45 3 6V8C3 9.66 4.34 11 6 11"
        stroke={color}
        strokeWidth={2}
        strokeLinecap="round"
      />
      <path
        d="M18 5H20C20.55 5 21 5.45 21 6V8C21 9.66 19.66 11 18 11"
        stroke={color}
        strokeWidth={2}
        strokeLinecap="round"
      />
      <path
        d="M12 15V18M8 21H16M12 18H12C10.9 18 10 18.9 10 20V21H14V20C14 18.9 13.1 18 12 18Z"
        stroke={color}
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function UserPlusIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M2 21C2 17.134 5.13 14 9 14H13C16.866 14 20 17.134 20 21"
        stroke={color}
        strokeWidth={2}
        strokeLinecap="round"
      />
...
export function ShareIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path d="M12 4V15" stroke={color} strokeWidth={2} strokeLinecap="round" />
      <path
        d="M8 8L12 4L16 8"
        stroke={color}
        strokeWidth={2}
...
export function SwapIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path
        d="M5 8H17M17 8L14 5M17 8L14 11"
        stroke={color}
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path
        d="M19 16H7M7 16L10 13M7 16L10 19"
        stroke={color}
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function CoinIcon({ size = 24 }: { size?: number }) {
  const gradientNamespace = useId().replaceAll(":", "");
  const coinGoldRadId = `${gradientNamespace}-coin-gold`;
  const coinRimGradId = `${gradientNamespace}-coin-rim`;
  const coinShineGradId = `${gradientNamespace}-coin-shine`;

  return (
    <IconSvg width={size} height={size} viewBox="0 0 521 512">
      <defs>
        <radialGradient id={coinGoldRadId} cx="35%" cy="30%" r="70%">
        ...
        <linearGradient id={coinRimGradId} x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#FFE27C" />
          <stop offset="55%" stopColor="#F3A82B" />
          <stop offset="100%" stopColor="#C56B0A" />
        </linearGradient>
        <linearGradient id={coinShineGradId} x1="0" y1="0" x2="1" y2="1">
      ...
      {/* Smile */}
      <path
        d="M206 290 C232 318, 280 318, 306 290"
        fill="none"
        stroke="#1A1208"
        strokeWidth={14}
        strokeLinecap="round"
...
export function DustIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 256 256" fill={color}>
...
export function RecycleIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg
      width={size}
      height={size}
...
export function ClaimedIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <circle
        cx={12}
...
export function XCircleIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <circle cx={12} cy={12} r={10} stroke={color} strokeWidth={2} />
      <path
...
export function SparklesIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M19 13l.7 2L22 16l-2.3.7L19 19l-.7-2.3L16 16l2.3-.7L19 13z"
        fill={color}
      />
      <path
        d="M5.5 15l.5 1.5L7.5 17l-1.5.5L5.5 19l-.5-1.5L3.5 17l1.5-.5L5.5 15z"
        fill={color}
      />
    </IconSvg>
  );
...
export function WordleQuestIcon({
  size = 24,
  color = "currentColor",
}: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <rect x={4} y={4} width={4.6} height={4.6} rx={1} fill={color} />
      <rect
        x={9.7}
        y={4}
        width={4.6}
      ...
      <rect
        ...
        fillOpacity={0.46}
      />
      <rect x={9.7} y={9.7} width={4.6} height={4.6} rx={1} fill={color} />
      <rect
        x={15.4}
        y={9.7}
        width={4.6}
      ...
      <rect
        ...
        fillOpacity={0.46}
      />
      <rect x={15.4} y={15.4} width={4.6} height={4.6} rx={1} fill={color} />
    </IconSvg>
  );
}
...
export function GiftBoxIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <rect
        x={4}
...
export function BoxIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <path
...
export function SparkleIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M6 17C6.1 17.8 6.25 18.6 6 19C6.7 18.75 7.2 18.9 8 19C7.2 19.1 6.7 19.25 6 19C6.25 19.7 6.1 20.2 6 21C5.9 20.2 5.75 19.7 6 19C5.3 19.25 4.8 19.1 4 19C4.8 18.9 5.3 18.75 6 19C5.75 18.3 5.9 17.8 6 17Z"
        fill={color}
        fillOpacity={0.45}
      />
    </IconSvg>
...
// Exact Ionicons 8 `search` geometry used by the mobile search affordances.
export function SearchIcon({ size = 24, color = "currentColor" }: IconProps) {
  return (
    <IconSvg width={size} height={size} viewBox="0 0 512 512" fill={color}>
