...
function HeaderSettingsIcon({ size = 24, color = "#EC4899" }: { size?: number; color?: string }) {
  return (
  ...
  return (
    <View style={{ paddingTop: insets.top }}>
      <View className="flex-row items-center justify-between px-4 py-2">
        <View className="flex-row items-center gap-2 rounded-full bg-[#FDE047] px-4 py-1.5">
          <CoinIcon size={20} />
        ...
        <View className="flex-row items-center" style={{ columnGap: 16 }}>
          ...
          <Pressable onPress={() => router.push("/(tabs)/settings")} hitSlop={8}>
            ...
            >
              <HeaderSettingsIcon size={24} color="#EC4899" />
            </View>
          </Pressable>
        </View>
      </View>
