        ...
        <View className="h-full w-full overflow-hidden rounded-xl bg-slate-900 shadow-lg">
          {imageUrl ? (
            ...
            <View className="absolute inset-0 items-center justify-center bg-slate-700">
              <Text className="font-nunito-extrabold text-4xl text-white">
                {unit.name.charAt(0)}
              </Text>
            </View>
          )}
          ...
          <View className="absolute left-1 top-1" style={{ width: "40%" }}>
            <Text
              className="font-nunito text-[9px] italic text-gray-200"
              numberOfLines={1}
            >
              {unit.name}
            </Text>
            <Text
              className="font-nunito-bold text-[10px] text-white"
              numberOfLines={1}
            >
          ...
          {hasPublicPassive ? (
            <View
              ...
              className="absolute left-1 top-[27px] h-5 w-5 items-center justify-center rounded-full bg-amber-400/95"
            >
              <SparklesIcon size={11} color="#78350F" />
            </View>
          ) : null}

          <View
            className="absolute flex-row items-center"
            style={{ left: 4, bottom: 18, gap: 3 }}
          >
            <View
              style={{
            ...
            <Animated.View
              ...
              style={{
                ...
                borderColor: isSelected
                  ? "#67E8F9"
                  : isValidTarget
                    ? (typeEffectiveness?.border ?? "#67E8F9")
...
function StatBadge({
  ...
  return (
    ...
    >
      <Text
        style={{ color: "#fff", fontSize: 7, fontFamily: "Nunito_700Bold" }}
      >
        {label} {value}
