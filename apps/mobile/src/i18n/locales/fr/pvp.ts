const pvp = {
  ...
  combatLog: {
    ...
    matchStart: "Le match commence{roll}",
    initiativeTieRollDetail: " (égalité d'initiative {roll})",
    ...
    passiveRollFail: "Le jet du passif {ability} de {unit} échoue ({roll})",
  ...
  activeBattleTurnUnknown: "Tour en cours d'actualisation",
  activeBattleTeams: "{mine} contre {theirs} cartes",
  activeBattleUpdated: "Mis à jour {time}",
  unknownPlayerWithId: "Joueur {id}",
  win: "VICTOIRE",
  loss: "DÉFAITE",
  draw: "ÉGALITÉ",
  timeoutWin: "VICTOIRE TEMPS",
  timedOut: "TEMPS ÉCOULÉ",
  concedeWin: "VICTOIRE ABANDON",
  conceded: "ABANDON",
