const quests = {
  ...
  dailyNumbers: {
    ...
    helperLine:
      "Règle de BMO : chaque pas vers la cible débloque plus de récompense, et un résultat exact s'envoie automatiquement à 100 %.",
    archiveHelperLine:
      "Les archives gardent ton meilleur résultat et ton temps, mais ne donnent jamais de pièces.",
    bmoQuestTitle: "La quête des nombres de BMO",
    bmoIntro: "BMO dit : fabrique le nombre cible !",
    bmoVerdict: "Rapport de quête de BMO",
    targetTaunt: "Tu crois pouvoir m'attraper ?",
    targetMoodSafe: "La cible se cache quelque part dans Ooo.",
    targetMoodNoticed: "Mathématique ! Tu te rapproches.",
    targetMoodFaster: "BMO voit un chemin parmi les nombres.",
    targetMoodNervous: "La cible commence à trembloter.",
    targetMoodOneAway: "À un près ! C'est totalement algébrique.",
    targetMoodReady: "BMO a calculé {result}. Touche-le pour le lancer.",
    target: "Cible",
    ...
    availableNumbers: "Pierres-nombres",
    pickTroublemakers: "Choisis deux nombres suspects",
    usedNumbers: "Nombres utilisés",
    operators: "Boutons magiques",
    ...
    makeValue: "Fabriquer {value}",
    makeNumber: "Machine à nombres de BMO",
    undo: "Annuler la dernière étape",
    undoPlayful: "Annuler",
    reset: "Réinitialiser",
    resetPlayful: "Recommencer",
    submit: "Terminer la quête",
    submitPlayful: "On garde ça !",
    ...
    mathTrail: "La piste de l'Enchiridion",
    noStepsYet:
      "Cette page de l'Enchiridion est vide. Combine deux pierres-nombres pour commencer.",
    ...
    resultExactQuip: "Algébrique ! BMO a trouvé la cible exacte.",
    resultOneAwayQuip:
      "À un près. Même la Princesse Chewing-Gum serait impressionnée.",
    resultNearQuip: "Si près ! La cible s'est échappée de justesse dans Ooo.",
    resultMidQuip: "Un coup héroïque dans la bonne direction.",
    resultFarQuip:
      "La cible s'est réfugiée au Royaume de la Confiserie. Pour l'instant.",
    resultNoQuip: "Raté cette fois. BMO est prêt pour une autre quête.",
    chaseTime: "Temps de poursuite",
    resetNotice:
    ...
    shareResult: "Partager le résultat",
    shareEvidence: "Partager la preuve",
    sharePreparing: "Préparation…",
    shareBrand: "Adventure Time TCG",
    shareFooter: "Quête quotidienne",
    gameShareFooter: "Quête des nombres de BMO • Nombres du jour",
    gameShareArchiveFooter: "Quête des nombres de BMO • Partie d'archive",
    archiveTargetQuip:
      "Une vieille page de l'Enchiridion ! Pas de pièces, juste des calculs inachevés.",
    shareDialogTitle: "Partage ton résultat de quête",
    shareError: "Impossible de créer l'image à partager. Réessaie.",
    shareUnavailable: "Le partage n'est pas disponible sur cet appareil.",
