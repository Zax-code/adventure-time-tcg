const quests = {
  ...
  dailyNumbers: {
    ...
    catchThis: "Attrape-moi !",
    targetTaunt: "Tu crois pouvoir m'attraper ?",
    targetMoodSafe: "Même pas peur.",
    targetMoodNoticed: "Oh. Tu m'as remarqué.",
    targetMoodFaster: "Hé, tu te rapproches.",
    targetMoodNervous: "Bon, là, je commence à transpirer.",
    targetMoodOneAway: "À UN près ?! Tu plaisantes ?",
    targetMoodReady: "Oh non. Voilà {result} qui arrive.",
    target: "Cible",
    ...
    makeNumber: "Fabriquer un nombre",
    undo: "Annuler la dernière étape",
    undoPlayful: "Oups, annuler",
    reset: "Réinitialiser",
    resetPlayful: "Nouveau plan !",
    ...
    mathTrail: "La piste des calculs louches",
    noStepsYet:
    ...
    resultExactQuip: "Dans le mille. La cible n'avait aucune chance.",
    resultOneAwayQuip: "À un près. La cible a senti passer le vent.",
    resultNearQuip: "Si près que la cible porte réclamation.",
    resultMidQuip: "Pas mal. La cible a arrêté de rigoler.",
    resultFarQuip: "La cible garde son petit sourire. Pour l'instant.",
    resultNoQuip: "Raté cette fois. La cible a eu de la chance.",
    ...
    shareBrand: "Adventure Time TCG",
    shareFooter: "Quête quotidienne",
    gameShareFooter: "Attrape la cible • Nombres du jour",
    gameShareArchiveFooter: "Attrape la cible • Partie d'archive",
    archiveTargetQuip: "Pas de pièces ici. Juste de vieux comptes à régler.",
    shareDialogTitle: "Partage ton résultat de quête",
    shareError: "Impossible de créer l'image à partager. Réessaie.",
    shareUnavailable: "Le partage n'est pas disponible sur cet appareil.",
