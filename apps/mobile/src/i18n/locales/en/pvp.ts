const pvp = {
  ...
  challengeSheetIntro:
    "Search quickly, pick a ready loadout, then choose an available player.",
  ...
  showBusyPlayers: "Show busy players ({count})",
  hideBusyPlayers: "Hide busy players",
  showBusyPlayersAction: "Show",
  hideBusyPlayersAction: "Hide",
  busyPlayersHint: "These players already have a battle or invite in progress.",
  noBusyPlayerMatches: "No busy players match this search.",
