const pvp = {
  ...
  combatLog: {
    title: "Combat Log",
    empty: "No events yet.",
    matchStart: "Match started{roll}",
    initiativeTieRollDetail: " (initiative tie {roll})",
    ...
    shieldAbsorb: "{target}'s shield absorbed {amount} damage",
    ...
    passiveRollFail: "{unit}'s passive {ability} roll failed ({roll})",
    passiveTrigger: "{unit}'s passive {ability} triggered",
    statusRollPass: "{status} roll applied to {target} ({roll})",
    statusRollFail: "{status} roll failed on {target} ({roll})",
    randomStatusRoll: "Random status chose {status} for {target} ({roll})",
    randomChoiceDetail: "roll {roll}, option {selected}/{count}",
    cooldownTick: "{target}'s {ability} cooldown is now {count}",
    freezeSkip: "{target} skipped an action from Freeze",
    stunConsume: "{target} consumed Stunned",
  ...
  activeBattleYourTurn: "Your turn",
  activeBattleTheirTurn: "Opponent's turn",
  activeBattleTurnUnknown: "Turn status updating",
  activeBattleTeams: "{mine} vs {theirs} cards",
  activeBattleUpdated: "Updated {time}",
  unknownPlayerWithId: "Player {id}",
  win: "WIN",
  loss: "LOSS",
  draw: "DRAW",
  ...
  noSkill: "No skill assigned.",
  noUltimate: "No ultimate assigned.",
