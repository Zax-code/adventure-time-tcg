const admin = {
  ...
  users: {
    ...
    assessmentTitle: "Trust assessment",
    assessmentAssessing: "Assessment in progress",
    assessmentUnavailable: "Not enough evidence for a score",
    assessmentTestLab: "Firebase Test Lab environment (no trust score)",
    assessmentGoogleNetwork:
      "Google-owned network; not a published Test Lab range",
    assessmentConfidence: "Trustworthiness confidence",
    assessmentCoverage: "Evidence coverage",
    assessmentHeuristic: "Advisory heuristic",
    assessmentMissing: "Missing evidence",
    assessmentPositive: "Positive evidence",
    assessmentNegative: "Negative evidence",
    assessmentHardFailures: "Hard failures",
    assessmentModel: "Model",
    assessmentAge: "Assessment age",
    assessmentTestLabRange: "Matched Test Lab range",
    assessmentRangeVersion: "Range-set version",
    assessmentShowEvidence: "Show evidence details",
    assessmentHideEvidence: "Hide evidence details",
    assessmentBandStronger: "Stronger trust signals",
    assessmentBandMixed: "Mixed trust signals",
    assessmentBandConcerning: "Concerning trust signals",
    assessmentTestLabWarning:
      "This match does not itself prove a Play pre-launch report.",
    assessmentRangeStale:
      "Warning: this network range list is more than 90 days old.",
    assessmentNetworkDetails: "Network details",
    assessmentNetworkFlags: "Network flags",
    assessmentNetworkFlagsNone: "None reported",
    assessmentAsn: "ASN",
    assessmentCountry: "Country",
    assessmentConnectionType: "Connection",
    assessmentConnectionMobile: "Mobile",
    assessmentConnectionResidential: "Residential",
    assessmentConnectionCorporate: "Corporate",
    assessmentConnectionDatacenter: "Data center",
    assessmentConnectionOther: "Other",
    assessmentFlagVpn: "VPN",
    assessmentFlagProxy: "Proxy",
    assessmentFlagHosting: "Hosting",
    assessmentFlagTor: "Tor",
    assessmentReasons: {
      unknown: "Unrecognized assessment evidence",
      assessmentRescorePending: "Assessment refresh is pending",
      clientBrowserRequestShape: "Request looks like an ordinary browser",
      clientInstallationChanged: "Installation identifier changed",
      clientInstallationContinuous: "Installation identifier is consistent",
      clientInstallationMalformed: "Installation identifier is malformed",
      clientIntegrityBuildCorroborated:
        "Play Integrity confirms the claimed build",
      clientPlatformAgrees: "Platform and user agent agree",
      clientPlatformConflict: "Platform and request shape conflict",
      clientReleasedBuild: "App build is in the release registry",
      clientSameSiteOrigin: "Browser origin matches this site",
      clientUnrecognizedBuild: "Claimed app build is not recognized",
      continuityInstallationManyIdentities:
        "Installation is associated with many identities",
      continuityInstallationRepeated: "Installation has appeared before",
      continuityIpManyIdentities: "Network is associated with many identities",
      continuityLowAttemptVolume: "Recent request volume is low",
      continuityProviderIdentityRepeated:
        "Provider identity has appeared before",
      continuityRecentAttemptBurst: "Recent request burst detected",
      continuityRequestAttemptsHigh: "This request has many attempts",
      identityEmailVerificationPending: "Email verification is pending",
      identityEmailVerified: "Email address is verified",
      identityProviderEmailUnverified: "Provider email is not verified",
      identityProviderMappingConflict: "Provider identity mapping conflicts",
      identityProviderMappingRepeated:
        "Provider identity mapping is consistent",
      identityProviderVerified: "Identity provider verified the account",
      integrityCertificateMismatch: "App signing certificate does not match",
      integrityLicensed: "Google Play reports a licensed install",
      integrityMeetsBasic: "Device meets basic integrity",
      integrityMeetsDevice: "Device meets device integrity",
      integrityMeetsStrong: "Device meets strong integrity",
      integrityNoDevice: "Device integrity was not met",
      integrityNotSubmitted: "Play Integrity evidence was not submitted",
      integrityPackageMismatch: "App package does not match",
      integrityPlayRecognized: "Google Play recognizes the app version",
      integrityProviderAuthUnavailable:
        "Play Integrity authentication is unavailable",
      integrityProviderInvalidResponse:
        "Play Integrity returned an invalid response",
      integrityProviderNetworkError: "Play Integrity could not be reached",
      integrityProviderQuotaExhausted: "Play Integrity quota is exhausted",
      integrityProviderTimeout: "Play Integrity timed out",
      integrityProviderUnavailable: "Play Integrity is unavailable",
      integrityReleasedBuildVerified: "Released build was verified",
      integrityRequestHashMismatch:
        "Integrity response does not match this request",
      integrityUnevaluated: "Google Play could not evaluate integrity",
      integrityUnlicensed: "Google Play reports an unlicensed install",
      integrityUnrecognizedVersion:
        "App version is not in the release registry",
      integrityVersionMismatch: "Verified app version does not match the claim",
      ipActiveTor: "Network is an active Tor exit",
      ipBotStatus: "Network provider reports bot activity",
      ipCanonicalUnavailable: "A trustworthy client IP is unavailable",
      ipHighRiskAttacks: "Network provider reports high-risk attacks",
      ipEnrichmentPending: "Network intelligence is pending",
      ipFrequentAbuser: "Network provider reports frequent abuse",
      ipHosting: "Network is classified as hosting",
      ipProviderUnavailable: "Network intelligence provider is unavailable",
      ipProxy: "Network is classified as a proxy",
      ipPublicAccessPoint: "Network is a public access point",
      ipRecentAbuse: "Network provider reports recent abuse",
      ipSharedConnection: "Network is a shared connection",
      ipVpn: "Network is classified as a VPN",
    },
    assessmentRevealIp: "Reveal exact IP (audited)",
