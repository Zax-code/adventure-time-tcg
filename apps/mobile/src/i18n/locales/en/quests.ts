const quests = {
  ...
  dailyNumbers: {
    ...
    helperLine:
      "BMO's rule: every move toward the target unlocks more of the reward, and an exact hit auto-submits at 100%.",
    archiveHelperLine:
      "Archive boards keep your best result and time, but never award coins.",
    bmoQuestTitle: "BMO's number quest",
    bmoIntro: "BMO says: make the target number!",
    bmoVerdict: "BMO's quest report",
    targetTaunt: "Bet you can't catch me.",
    targetMoodSafe: "The target is hiding somewhere in Ooo.",
    targetMoodNoticed: "Mathematical! You're getting closer.",
    targetMoodFaster: "BMO sees a path through the numbers.",
    targetMoodNervous: "The target is getting all wiggly.",
    targetMoodOneAway: "One away! That's totally algebraic.",
    targetMoodReady: "BMO calculated {result}. Tap it to cast.",
    target: "Target",
    ...
    availableNumbers: "Number stones",
    pickTroublemakers: "Pick two troublemakers",
    usedNumbers: "Used numbers",
    operators: "Magic buttons",
    ...
    makeNumber: "BMO's number machine",
    undo: "Undo last step",
    undoPlayful: "Undo",
    reset: "Reset board",
    resetPlayful: "Reset",
    submit: "Finish quest",
    submitPlayful: "Call it!",
    ...
    mathTrail: "Enchiridion math trail",
    noStepsYet:
      "This Enchiridion page is blank. Combine two number stones to begin.",
    ...
    resultExactQuip: "Algebraic! BMO found the target exactly.",
    resultOneAwayQuip: "One away. Even Princess Bubblegum would be impressed.",
    resultNearQuip: "So close! The target barely escaped across Ooo.",
    resultMidQuip: "A heroic bonk in the right direction.",
    resultFarQuip: "The target escaped into the Candy Kingdom. For now.",
    resultNoQuip: "No catch this time. BMO is ready for another quest.",
    chaseTime: "Chase time",
    resetNotice:
    ...
    selectedTilePosition: "Number {value}, operand {position}",
    tileValue: "Number tile {value}",
    tileUnavailable: "Number {value}, unavailable for the current selection",
    operatorValue: "Operator {operator}",
    operatorUnavailable:
      "Operator {operator}, unavailable for the selected numbers",
    ...
    shareResult: "Share result",
    shareEvidence: "Share the evidence",
    sharePreparing: "Preparing…",
    shareBrand: "Adventure Time TCG",
    shareFooter: "Daily Quest",
    gameShareFooter: "BMO's Number Quest • Daily Numbers",
    gameShareArchiveFooter: "BMO's Number Quest • Archive run",
    archiveTargetQuip:
      "An old Enchiridion page! No coins, just unfinished math business.",
    shareDialogTitle: "Share your quest result",
    shareError: "Could not create the share image. Try again.",
    shareUnavailable: "Sharing isn't available on this device.",
