const quests = {
  ...
  dailyNumbers: {
    ...
    targetMoodSafe: "I'm extremely safe over here.",
    targetMoodNoticed: "Oh. You noticed me.",
    targetMoodFaster: "Hey, you're getting closer.",
    targetMoodNervous: "Okay, this is getting rude.",
    targetMoodOneAway: "ONE away?! Absolutely not.",
    targetMoodReady: "Uh-oh. {result} is incoming.",
    target: "Target",
    ...
    makeNumber: "Make a number",
    undo: "Undo last step",
    undoPlayful: "Oops, undo",
    reset: "Reset board",
    resetPlayful: "New plan!",
    ...
    mathTrail: "Trail of questionable math",
    ...
    resultExactQuip: "Bullseye. The target never stood a chance.",
    resultOneAwayQuip: "One away. The target felt the breeze.",
    resultNearQuip: "So close, the target is filing a complaint.",
    resultMidQuip: "A respectable bonk in the right direction.",
    resultFarQuip: "The target remains smug. For now.",
    resultNoQuip: "No catch this time. The target got lucky.",
    ...
    shareBrand: "Adventure Time TCG",
    shareFooter: "Daily Quest",
    gameShareFooter: "Catch the Target • Daily Numbers",
    gameShareArchiveFooter: "Catch the Target • Archive run",
    archiveTargetQuip:
      "No coins here. Just old targets and unfinished business.",
    shareDialogTitle: "Share your quest result",
    shareError: "Could not create the share image. Try again.",
    shareUnavailable: "Sharing isn't available on this device.",
